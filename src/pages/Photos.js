...
const Photos = () => {
  ...
  const fetchData = async () => {
    try {
      let searchURL = `https://pixabay.com/api?page=${page}&q=${search}&key=27230200-4daa76668a97ef01016d3bd28`;
  ...
  return (
    <div className="bg-green-300 w-full flex flex-col items-center p-[1rem] min-h-[40rem]">
      <h1 className="section-title !text-4xl !my-[1rem]">Stock Photos</h1>
